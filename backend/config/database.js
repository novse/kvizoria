...
// Приоритет: сначала переменные Railway (MYSQL*), затем обычные DB_*
const dbConfig = {
...
// Функция инициализации базы данных (создание таблиц и тестовых данных)
